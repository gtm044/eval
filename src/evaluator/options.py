...
class ValidationOptions(BaseModel):
    ...
    generateReport: Optional[bool] = Field(
        default = False,
    ...
    @field_validator("metrics", pre=True)
    def check_metrics(cls, v, info):
        implemented_metrics = ["avg_chunk_size", "jaccard_index", "context_relevance", "context_recall", "context_precision", "retrieval_similarity", "named_entity_score"]
